...
@DataJpaTest
 class DepartmentRepositoryTest {
    ...
    @DisplayName("JUnit test for save department operation")
     void givenDepartmentObject_whenSave_thenReturnSavedDepartment() {
    ...
    @DisplayName("JUnit test for find all departments operation")
     void givenDepartmentList_whenFindAll_thenReturnDepartmentList() {
    ...
    @DisplayName("JUnit test for find by id department operation")
     void givenDepartmentId_whenFindById_thenReturnDepartmentObject() {
        Department savedDepartment = departmentRepository.save(department);
    ...
    @DisplayName("JUnit test for delete department operation")
     void givenDepartmentObject_whenDelete_thenRemoveDepartment() {
    ...
    @DisplayName("JUnit test for finding department by name")
     void givenDepartmentName_whenFindByName_thenReturnDepartmentObject() {
        departmentRepository.save(department);
